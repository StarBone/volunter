    ...
    <section class="flex gap-5 items-start mx-20">
        <aside class="w-2/6 ml-4 sticky top-5">  
            ...
            <div class="p-6 mt-4 flex flex-col gap-4 bg-white text-sm">  
                <a href="/status/my-activity" class="py-4 px-5 flex items-center gap-5 hover:bg-sky-100 hover:border-sky-700 border border-transparent rounded-xl">
            ...
            <div class="mt-4">
                <div class="mt-6 p-6 bg-white rounded-lg">  
                    ...
                    <div class="my-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">  
                        <div class="p-1 w-56 flex flex-col border border-neutral-200 rounded-xl">  
