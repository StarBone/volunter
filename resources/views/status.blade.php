...
<x-app-layout>  
    ...
    <section class="flex gap-5 items-start mx-20">
            ...
            <div class="p-6 relative bg-white rounded-lg ">
                <div class="flex items-center justify-between gap-5">
                    <div class="flex items-center gap-5">
                        <svg class="w-5" version="1.1" id="fi_266033" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <g>
                    ...
                    <button class="flex items-center gap-1 border border-sky-700 py-2 px-3 rounded-full">
        ...
        <div class="relative w-4/6 flex-grow"> 
            <div class="flex">
                <span class="text-xl font-bold">Aktivitas Saya</span>
            </div>
            <div class="mt-4">
