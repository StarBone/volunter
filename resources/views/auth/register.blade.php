            ...
            <div class="relative h-screen md:w-1/2" id="card-1">
                <div class="mt-10 m-6 lg:mr-20 lg:ml-20 xl:mr-36">
                    ...
                    <div class="flex flex-col space-y-2 mt-3">
                        ...
                        <x-text-input id="phone" class="block w-full placeholder-neutral-200" type="number" name="phone" :value="old('phone')" required placeholder="Masukkan nomor telepon Anda" />
                    ...
                    <div class="flex flex-col space-y-2 mt-3">
                        ...
                        <div x-data="{ showPassword: false }" class="relative">
                            <x-text-input-pass id="password" class="w-full placeholder-neutral-200"
