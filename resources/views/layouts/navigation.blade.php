    <nav x-data="{ open: false }" class="bg-white w-[97%] rounded-lg mt-3 mb-4 mx-auto">  
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">  
                    <x-dropdown align="right" width="48">  
                        <x-slot name="trigger">  
                            ...
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-full text-white bg-sky-600 hover:bg-sky-700 focus:outline-none focus:bg-sky-700 transition ease-in-out duration-150">  
                                {{ __('Daftar') }}  
