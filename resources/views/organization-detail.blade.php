        ...
        <aside class="mt-10 w-2/6 ml-4 sticky top-5">  
            <div class="p-6 relative bg-white rounded-lg ">  
                ...
                <div class="relative pt-5 flex flex-col text-sm gap-4 fill-gray-500 text-gray-500">
                    <svg class="w-5 absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">  
                    ...
                    <svg class="w-5 absolute top-[56px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">  
                    ...
                    <svg class="w-5 absolute top-[94px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">  
                    ...
                    <span class="ml-7">johndoe@gmail.com</span>

                    <svg class="ml-0.5 w-5 absolute top-[130px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 482.6 482.6">  
